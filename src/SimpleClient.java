	...
	public static void main(String[] args) {
        ...
        if(args.length==0) {
            ...
            try {
            	...
            	System.out.println("Whoops, invalid port number.  "
            			+ "Will default to 9999");
            	port = 9999;
            }
        }
        
        try {
        	System.out.println("Client will attempt connecting to server "
        			+ "at host=" + host + " port=" + port + ".");
